...
**Premium motion design.** Read [references/motion-design.md](references/motion-design.md). Every animation must feel purposeful, physics-based, and professionally choreographed. No linear easing, no simultaneous reveals, no decorative particles.
