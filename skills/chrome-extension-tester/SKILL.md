...
description: "Testing workflow for Chrome extensions with bene2luxe backend integration. Use when: (1) Testing Snapchat Auto Add extension features, (2) Registering devices with the bene2luxe backend, (3) Debugging extension behavior, (4) Accessing popup and service worker logs, (5) Running automation tests against the extension."
---
...
3. Fill Snapchat Account: `agent-browser fill "ref=e11" "cobou.dev"`
...
```
/Users/vakandi/Documents/MultiSaasDeploy/snapchat_army/snapchat_ecommerce_chrome_extension/
```
