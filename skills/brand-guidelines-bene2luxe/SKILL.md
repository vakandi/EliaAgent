...
description: YourBrand brand guidelines, colors, typography, and graphical style for consistent branding across all interfaces. Use this skill whenever adding branding elements, redesigning components, or creating new features for the luxury fashion resale platform.
---
...
**YourBrand** is a luxury fashion resale marketplace serving France and Switzerland. The brand represents:
...
*For YourBrand Luxury Fashion Resale Platform - France/Switzerland*
