...
OpenCode TUI (Terminal UI) stopped opening after the user modified the codemem memory system at `/Users/vakandi/EliaAI/integrations/codemem`. 
...
1. User modified files in `/Users/vakandi/EliaAI/integrations/codemem` (memory system)
...
{
  "plugin": [
    "file:///Users/vakandi/.config/opencode/plugins/open-island.js",
    "file:///Users/vakandi/.config/opencode/plugins/codemem.js"
  ]
}
```

**Codemem Plugin:**
- Symlink: `~/.config/opencode/plugins/codemem.js` → `/Users/vakandi/EliaAI/integrations/codemem/packages/opencode-plugin/.opencode/plugins/codemem.js`
...
- `/Users/vakandi/EliaAI/integrations/codemem/packages/opencode-plugin/.opencode/plugins/codemem.js`
