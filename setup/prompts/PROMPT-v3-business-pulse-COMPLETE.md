...
mcp-cli call whatsapp list_messages '{"chat_jid":"B2LUXE_JID","limit":20}'
mcp-cli call whatsapp list_messages '{"chat_jid":"COBOU_JID","limit":10}'
mcp-cli call whatsapp list_messages '{"chat_jid":"MAYAVANTA_JID","limit":10}'
...
```bash
for site in bene2luxe.com zovaboost.com; do
...
```bash
# Search all sources
grep -i "en attente\|waiting\|blocked\|depuis\|48h" /Users/vakandi/EliaAI/memory/MEMORY.md | head -10
...
|-----------|--------|---------|------------------|
| Stripe verification | Wael | Telegram | "Stripe deadline proche. Besoin d'aide?" |
